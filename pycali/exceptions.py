class MissingAction(Exception):
    ...
    def __str__(self):
        ...
        return ("All actions of the vocabulary should be in the license or Undefined status should be in the restrictiveness lattice of status")


class MissingStatus(Exception):

    def __str__(self):
        """Raise if a status in the license is not in the restrictiveness lattice of status."""
        return ("All status of a license should be in the restrictiveness lattice of status")
